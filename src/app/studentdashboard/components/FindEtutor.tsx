...
const ETutorSearch = ({
  ...
  const SearchForm = () => (
    <div className="space-y-4  bg-[#EDE8FA] px-6 py-6 rounded-3xl max-w-[62.5rem] mx-auto mt-9  min-h-screen  ">
      <div className="flex justify-between items-center flex-col custom-xl:flex-row space-x-2 pt-6">
        <h1 className=" text-3xl custom-xl:text-5xl font-bold text-[#685AAD] pl-10">Find eTutor</h1>
  ...
  const ResultsView = () => (
    <div className="bg-[#EDE8FA] w-full h-full rounded-3xl px-8 py-6">
      <div className="flex  mt-8 justify-between ">
        <h1 className="text-5xl font-bold text-[#685AAD] px-1 mb-3">Find your eTutor</h1>
  ...
  const ProfileView: React.FC<{ tutor: ITeacher | any; showTerminateEngament?: any }> = ({
    tutor,
    showTerminateEngament,
  }) => {
              ...
              <div className="">
                <div className="w-full max-w-[400px] md:max-w-[773px]  bg-white rounded-3xl  px-5 md:px-14 py-5 md:py-14 flex flex-col ">
                  ...
                  <p className="text-lg md:text-[27.71px] leading-tight text-[#8653FF]  mt-4 ">
                    ...
                    {tutor?.contactInformation.firstName}? This action cannot be undone.
                  </p>
              ...
              <div className="my-12 custom-xl:my-[67px] ">
                ...
                <div className="w-full max-w-[725.17px] rounded-2xl bg-white p-6 shadow-lg md:px-11 md:py-10 ">
                  ...
                  <p className="mt-5  text-[14px]  text-[#685AAD] md:text-[21.47px] leading-tight">
                    Please let us know why you’re choosing to terminate this engagement. Your
                  ...
                  <p className="mb-4 pt-4 text-[14px] font-medium text-[#685AAD] md:text-[28.16px] leading-tight">
                    Please rate your experience with Mr. {tutor?.contactInformation.firstName}
                  </p>
        ...
        >
          ...
          <div className="bg-[#A296CC] rounded-3xl p-10 ">
            ...
            <p className="text-xs sm:text-md mb-4 text-[#564589] font-medium">
              You can change your membership by selecting one of the two other plans listed below,
              or visit the <span className="text-[#6949FF]">My Membership</span> page for more
              information.
            </p>
            {/* drop downs */}
            ...
            <p className="text-xs sm:text-lg mb-4">
              You currently have the <span className="text-[#6949FF]">Pay As You Go</span>{' '}
              membership plan. This free plan allows you to book an eTutor at any time, paying only
              the fees listed for each session. No upfront costs or subscription fees
            </p>
            ...
            <div className="bg-[#B9AFDB] p-6 rounded-3xl">
              {isTrialSession === true && parentdata?.user?.TrialSessionLeft > 0 ? (
                <button
                  onClick={() => {
  ...
  return (
    <div className="text-white">
      ...
      {showProfile && (
        <ProfileView tutor={selectedTutor} showTerminateEngament={showTerminateEngament} />
      )}
