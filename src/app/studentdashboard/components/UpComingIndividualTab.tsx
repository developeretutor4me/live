...
function UpComingIndividualTab({
  ...
  const onTutorChatClickHandler = (tutor: any) => {
    // Navigate to my-etutor page with tutor ID and chat parameter
    router.push(`/studentdashboard/my-etutor?etutor_id=${tutor?._id}&chat=true`);
  };

  const onEditSessionClickHandler = (request: any) => {
    // Navigate to the session detail page with the booking ID
    router.push(`/studentdashboard/sessions/${request._id}`);
  };
            ...
            return (
              ...
              >
                <div className="flex flex-col custom-xl:flex-row custom-xl:items-start h-full">
                      ...
                      <div className="flex flex-col custom-xl:block custom-xl:pt-2">
                        ...
                        >
                          <div className="flex  gap-6 items-center  mt-2">
                            ...
                            <span
                              onClick={() => {
                                router.push(`/studentdashboard/find-etutor/${request.teacher._id}`);
                              }}
                            >
                  ...
                  >
                    <button
                      onClick={() => router.push(`/studentdashboard/sessions/${request._id}`)}
