...
const HeroSoon = () => {
  return (
    <div className="hero_soon h-[90vh] flex flex-col justify-center items-center text-center px-20 mb:px-6 ">
      <h2 className="text-[13rem] font-extrabold text-darkBlue leading-tight xl:text-[10rem] lg:text-[8rem] mb:text-[3.5rem]">
        Coming Soon{' '}
      </h2>
      <p className="text-3xl text-[#473171] mt-16 max-w-3xl font-medium xl:text-2xl xl:mt-12 lg:text-xl lg:max-w-xl lg:mt-8 mb:text-sm mb:max-w-sm mb:mt-6">
