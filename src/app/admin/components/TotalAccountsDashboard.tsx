...
function TotalAccountsDashboard() {
        ...
        if (typeof window !== "undefined" && chartRef.current) {
            ...
            const renderChart = () => {
                const data = google.visualization.arrayToDataTable([
                    ...
                    ["eTutors", roleCounts.teacher, "#fc7777"],
    ...
    return (
        <div className=" h-full max-h-[560px] bg-[#ede8fa] px-3 custom-xl:px-6 py-3 custom-xl:py-8 col-span-1 row-span-2 rounded-md sm:rounded-xl  custom-lg:rounded-xl relative ">
            ...
            <div className="chart flex-grow h-full">
                ...
                <div ref={chartRef} className="w-full max-w-full h-[90%] " />
...
export default TotalAccountsDashboard;
