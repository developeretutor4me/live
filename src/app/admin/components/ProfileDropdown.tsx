...
function ProfileDropdown() {
  ...
  return (
    <header className={`flex justify-between items-center `}>
      <div ref={targetRef} className="flex items-center   space-x-4 relative  select-none ">
        ...
        >
          <div className="flex gap-3 items-center">
            ...
            <span className="text-sm custom-2xl:text-base font-bold text-[#685AAD]">Admin</span>
          </div>
