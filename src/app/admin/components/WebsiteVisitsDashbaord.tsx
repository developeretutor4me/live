...
function WebsiteVisitsDashbaord() {
    ...
    return (
        <div className="px-2 custom-xl:px-[14px] py-2 custom-xl:py-[9px] bg-[#ede8fa]  rounded-md sm:rounded-xl custom-lg:rounded-xl max-h-[168.61px] h-full">
            <div className="grid grid-cols-[50%_auto] h-full">
                <div className="flex flex-col justify-between h-full px-3 md:px-0 custom-lg:px-3 py-1.5">
                    ...
                    <h1 className="text-3xl md:text-4xl custom-lg:text-[44.55px]  leading-none text-[#b293fc] font-medium py-2 custom-lg:py-4">
...
export default WebsiteVisitsDashbaord;