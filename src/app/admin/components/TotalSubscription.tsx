...
const TotalSubscription: React.FC = () => {
  ...
  const total = subscriptionData.payAsYouGo + subscriptionData.premium + subscriptionData.standard;
      ...
      <div className="flex justify-around gap-8 mt-16">
        <div className="flex flex-col items-end ">
          <div className="flex items-center gap-3 text-base text-[#685AAD] font-bold">
            <div className="bg-[#fc7777] h-[25px] w-[25px] rounded-sm">&nbsp;</div> Pay as you go
          </div>
        ...
        <div className="flex flex-col items-end">
          <div className="flex items-center gap-3 text-base text-[#685AAD] font-bold">
            <div className="bg-[#8653FF] h-[25px] w-[25px] rounded-sm">&nbsp;</div> Premium
          </div>
          <span className="text-base text-[#685AAD] font-bold">
        ...
        <div className="flex flex-col items-end">
          <div className="flex items-center gap-3 text-base text-[#685AAD] font-bold">
            <div className="bg-[#00DAE5] h-[25px] w-[25px] rounded-sm">&nbsp;</div> Standard
          </div>
          <span className="text-base text-[#685AAD] font-bold">
