...
function DashboardGrid({
  ...
  return (
    <>
      ...
      <div className="  mb-40 sm:mb-0  custom-2xl:mb-10 2xl:mb-[135px] text-transparent">a</div>
      ...
      <div className={styles.gridContainer}>
        ...
        >
          <div className="flex  justify-between items-center px-0 pr-1">
            <h1 className="font-bold text-[23px] leading-[1.75rem]">THIS WEEK’S SCHEDULE</h1>
            <Image loading="lazy" src={lightcalender} alt="" className="w-[26px] h-[26px]" />
          </div>
                  ...
                  >
                    <div className="pl-2">
                      ...
                      <p className=" text-white text-[21px] leading-[1.75rem] capitalize">
                        {' '}
                        {request.teacher?.contactInformation.firstName || 'techer name'}
                      </p>
                    </div>
        ...
        <div className={`${styles.sessionchatbox}`}>
          ...
          >
            <div className="flex  justify-between items-center mb-[1px]">
              ...
              <Image loading="lazy" src={sessionicongray} alt="" className="w-[25px] h-[25px]" />
            </div>

            {sessionData
              .filter(
                (request: any) => request.status === 'accepted' && request.meetingCompleted === true
              )
              .map((request: any) => {
                return (
                  <div
                  ...
                  >
                    <div className="flex flex-col ">
                      ...
                      <div className="flex justify-between gap-4 custom-2xl:gap-10 ">
                        <span className="text-[17px] leading-[1.25rem]">Date</span>
          ...
          >
            <div className="flex  justify-between items-center ">
              ...
              <Image loading="lazy" src={chat2} alt="" className="w-[21px] h-[21px]" />
            </div>
        ...
        >
          <div className="flex  justify-between items-center pr-2">
            <h1 className="font-bold text-[23px] leading-[1.75rem] uppercase">24H SUPPORT</h1>
            <Image loading="lazy" src={chaticon} alt="" className="w-[25px] h-[25px]" />
          </div>

          <div className=" ">
            <div className="flex flex-col">
              <span className="text-[#685AAD] text-[16.4px] leading-[1.5rem]">Need help?</span>
              <span className="text-[#685AAD] text-[16.4px] leading-[1.5rem]">Contact us.</span>
            </div>
          </div>
        </div>
        {/* -----Notifications----------- */}
        ...
        <div
          className={`${styles.notifications} bg-[#EDE8FA] text-[#685AAD] rounded-2xl px-5 py-7 text-xl flex flex-col`}
        >
          <div className="flex justify-between items-center pr-2.5 mb-4">
            <h1 className="font-bold text-[23px] leading-[1.75rem] uppercase">NOTIFICATIONS</h1>
            <Image loading="lazy" src={bellgray} alt="" className="w-[20.5px] h-[20.5px]" />
          </div>

          {/* Scrollable notifications container */}
          <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-[#685AAD] scrollbar-track-transparent hover:scrollbar-thumb-[#8b55ff] scrollbar-thumb-rounded-full scrollbar-track-rounded-full">
            <div className="space-y-4 pr-2">
              {notifications &&
                ...
                notifications?.notifications.map((notification: any, index: number) => {
                  ...
                  return (
                    <div className="border-b-2 border-[#8b55ff39] py-2.5" key={index}>
              ...
              {/* <div className="border-b-2 border-[#8b55ff39] py-2.5">
                ...
                <p className="text-[14.89px] font-medium uppercase leading-[1.25rem] text-[#685AADB2]">
                  Our support team has responded to your inquiry. Click here to view the response.
                </p>
              </div> */}
            </div>
          </div>
        ...
        <div
          ...
          onClick={() => router.push('/parent/refer')}
        >
          ...
          <div>
            ...
            <p className="text-sm text-[#685AAD] font-medium tracking-[-0.015em]">
              Get 10 eTokis for each student and 5 eTokis for each tutor you successfully refer.
            </p>
          </div>
        </div>
      </div>
