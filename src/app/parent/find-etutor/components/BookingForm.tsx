...
interface BookingFormProps {
  ...
  isEditMode: boolean;
  onCancelEditBookingHandler: () => void | undefined;
  onAddBookingHandler: () => void;
  nextBookingStepHandler: () => void;
}
    ...
    <div>
      <div className="mb-8 w-[75%] mx-auto">
        ...
        <div className="mb-8 mt-8">
          <div className="bg-[#DBCAFF] rounded-2xl p-6">
            <h3 className="text-[#685AAD] font-normal text-md mb-4">
              Share any topics or goals you&apos;d like your eTutor to focus on during your session
            </h3>
        ...
        <div className="space-y-6 mb-7">
          <div className="bg-[#DBCAFF] rounded-2xl p-4">
            <div className="flex items-center justify-between">
              <span className="text-[#6C5BAA] font-normal text-[16.58px]">TOTAL</span>
              <span className="text-[#6C5BAA] font-normal text-[16.58px]">$0.00</span>
            </div>
          </div>
        </div>
        ...
        {!isEditMode && (
          <button
            ...
            onClick={nextBookingStepHandler}
          >
            Next
          </button>
        )}
        {isEditMode && (
          <div className="flex justify-between">
            <button
              className="w-[49%] bg-[#8558F9] text-[#FFFFFF] py-4 rounded-full text-lg font-bold hover:bg-[#4a3a7a] transition-colors"
              onClick={onEditSaveHandler}
            >
              Save
            </button>
            <button
              className="w-[49%] bg-[#FC7777] text-[#FFFFFF] py-4 rounded-full text-lg font-bold hover:bg-[#4a3a7a] transition-colors"
              onClick={() => onCancelEditBookingHandler()}
            >
              Cancel
            </button>
          </div>
