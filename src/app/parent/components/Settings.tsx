    ...
    const fetchStudents = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          '/api/parent-Student-Relationship/parent-side-api/fetchAcceptedRequests',
          {
      ...
      <div className="px-5 custom-xl:px-10 py-5 custom-xl:py-10 flex gap-2 sm:gap-8 custom-xl:gap-16 ">
        ...
        >
          <div className="m-auto w-full  flex flex-col items-center  mt-20">
            <div className="rounded-full w-[5rem] h-[5rem] custom-xl:w-[11.4rem] custom-xl:h-[11.4rem]   overflow-hidden flex items-center justify-center">
              <img
