      ...
      <div className="bg-[#EDE8FA]  pt-12 pb-16 px-12 rounded-3xl">
        ...
        <div className="w-full max-w-[35.5rem] mt-11">
          <div className="relative  select-none mt-2 ">
            ...
            >
              <span className="my-1">
                {selectedTaxCountrys.length > 0 ? `${selectedTaxCountrys}` : 'select a Country'}
              </span>
                  ...
                  {TaxCountryOptions.map(TaxCountry => (
                    ...
                    >
                      <div className=" border-b border-white py-2 flex  gap-4  w-full px-4 max-w-[22rem] truncate">
                        <span className="ml-2 text-xl text-white ">{TaxCountry.label}</span>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      <div className="bg-[#EDE8FA] mt-16 rounded-3xl py-14 px-12">
        ...
        <div className="mt-16 pt-1">
          ...
          <div className="text-xl text-[#685AAD] mt-4">
            <p>
              As a self-employed tutor you are responsible for declaring and paying any applicable
              taxes and duties associated with the provision of the services, <br />
              such as income tax, VAT, and social security contributions.
            </p>
            <p className="mt-4">
              According to DAC7, an EU law to simplify tax cooperation between EU Member States,
              digital platform operators like eTutor4me are required to <br />
              collect and report information about individuals and business entities performing
              tutoring services via our platform to Austrian tax authorities. Data <br />
              will be reported annually to the Austrian tax authorities and exchanged automatically
              with competent tax authorities of other EU Member States. <br />
              Please be assured, that as we fulfil these legal obligations, we take the utmost care
              to protect your data in line with applicable laws on data protection <br />
              and privacy. For further information, we encourage you to check out our FAQs section.
            </p>
            <p className="mt-4">
              Please provide your tax information for EU member country you are tax resident,
            </p>
          </div>
        </div>
      </div>
