      ...
      <div className="px-14 py-10">
        ...
        <div className="flex items-center justify-between  flex-col custom-xl:flex-row">
          <div className="text-black text-start max-w-[46rem] text-sm sm:text-md custom-2xl:text-xl pt-12">
            <p>
              If you decide to switch to a different eTutor at a different level while on an ongoing
              membership package, your subscription will be adjusted to match the new eTutor&apos;s
              fee bracket. We will ask for your confirmation before making any changes
            </p>
          </div>
