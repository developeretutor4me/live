...
const UserProfile = ({ teacher, profilePicture }: UserProfileprops) => {
  const [activeTab, setActiveTab] = useState<'personal' | 'account' | 'Academic'>('personal');
      ...
      <div className="px-5 custom-xl:px-[42px] py-5 custom-xl:py-[46px] flex gap-2 sm:gap-8 custom-xl:gap-[68px]  h-full">
        ...
        >
          ...
          <div className="space-y-4 mt-[137px] ">
            <button
              className={`w-[99%] py-4  px-[38px] text-center rounded-3xl text-sm custom-xl:text-lg custom-xl:text-[30px] custom-xl:leading-[2rem]  font-roboto font-medium transition-all flex  ${
            ...
            <button
              className={`w-[99%] py-4  px-[38px] rounded-3xl text-sm custom-xl:text-lg custom-xl:text-[30px] custom-xl:leading-[2rem]  font-roboto font-medium transition-all flex ${
            ...
            <button
              className={`w-[99%] py-4  px-[38px] rounded-3xl text-sm custom-xl:text-lg custom-xl:text-[30px] custom-xl:leading-[2rem]  font-roboto font-medium transition-all flex ${
                activeTab === 'Academic' ? 'bg-white text-[#685AAD]' : 'text-[#685AAD]'
              }`}
              onClick={() => {
                          ...
                          <div className="bg-purple-100 rounded-xl py-[18px] px-10 flex items-center ">
                            ...
                            >
                              <div className="flex items-center gap-4  ">
                                ...
                                <span className="text-white text-xl">{selectedCountry.code}</span>
                              </div>
