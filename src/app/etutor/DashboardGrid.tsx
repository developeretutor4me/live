      ...
      >
                  ...
                  : etokies
                      ?.filter(
                        (etokie: any) =>
                          ...
                          new Date(etokie.createdAt).getFullYear() === new Date().getFullYear()
                      )
        ...
        <div
          className={`${styles.thirdcard} flex  gap-5 items-center pb-1 pt-3 px-6  bg-purple-100  rounded-3xl w-full ${
            isLargeScreen ? 'max-w-[23rem]' : 'w-full '
          } bg-[#EDE8FA]`}
        >
      ...
      <div className={styles.gridContainer}>
        <div className={`${styles.todaysSchedule} px-[26px] py-4 rounded-2xl`}>
          <div className="flex  justify-between items-center px-1">
            <h1 className="font-bold text-[25px] text-[#685AAD]">TODAY’S SCHEDULE</h1>
            <Image loading="lazy" src={lightcalender} alt="" className="w-[26.5px] h-[26.5px]" />
          </div>
        ...
        <div className={`${styles.completedSessions} px-[24px] py-6 rounded-2xl`}>
          <div className="flex  justify-between items-center">
            ...
            <Image loading="lazy" src={sessionicongray} alt="" className="w-[25.5px] h-[25.5px]" />
          </div>
        ...
        >
          <div className="flex  justify-between items-center ">
            <h1 className="font-bold text-[25px] text-[#685AAD] uppercase">Prefer your friends</h1>
            <Image loading="lazy" src={refergray} alt="" className="w-[22.2px] h-[22.2px]" />
          </div>
        ...
        >
          <div className="flex  flex-col">
            <h1 className="uppercase font-bold text-[25px] text-[#685AAD]">Trial Session</h1>
        ...
        >
          <div className="flex  justify-between items-center px-1">
            ...
            <Image loading="lazy" src={chat} alt="" className="w-[18px] h-[18px]" />
          </div>
