  ...
  return (
    <Layout>
      <div className="rounded-3xl md:rounded-[3rem] bg-[#EDE8FA] shadow-gray-300 shadow-2xl px-6 sm:px-11 py-6 max-w-[537px] w-full">
        ...
        <p className="text-[#9B85C8] text-[16px] lg:text-[20px] xl:text-[24px] 2xl:text-[27px] mt-[-5px] lg:mt-[-10px]">
          As a Parent
        </p>
        <div
          onClick={() => {
        ...
        <p className="text-[#534988] text-[16.38px] mt-5">
          ...
          <span className="underline text-xs custom-xl:text-base text-[#FC7777]">
