      ...
      <div className="flex  custom-lg:gap-4 items-start mb:flex-col gap-0">
        <div className="flex flex-col justify-between gap-12 mb:py-4 xl:gap-5 mb:gap-4 custom-lg:max-w-[15rem] 2xl:max-w-[25.3rem] w-full">
          <div className="flex flex-col gap-y-9 text-xl text-[#473171] lg:gap-5 xl:text-lg xl:gap-7 lg:text-base mb:text-sm mb:gap-4">
            <Link href="">
              {' '}
              <Image loading="lazy" alt="" src={logo} className="custom-2xl:w-[176px]" />
            </Link>
      ...
      <div className="  mt-2.5 text-xl text-[#473171] lg:gap-5 xl:text-lg xl:gap-7 lg:text-base mb:text-sm">
        <div className="flex gap-x-[23px] relative">
          <Image
            src={tiktok}
            alt=""
            className="w-[24.7px] transition-all duration-500 ease-in-out hover:scale-125 hover:drop-shadow-[0_0_10px_rgba(71,49,113,1)]  hover:cursor-pointer "
          />
          <Image
            src={instagram}
            alt=""
            className="w-[28.07px] transition-all duration-500 ease-in-out hover:scale-125 hover:drop-shadow-[0_0_10px_rgba(71,49,113,1)]   hover:cursor-pointer"
          />
          <Image
            src={X}
            alt=""
          ...
          <Image
            src={Youtube}
            alt=""
            className="w-[36.1px] transition-all duration-500 ease-in-out hover:scale-125 hover:drop-shadow-[0_0_10px_rgba(71,49,113,1)]   hover:cursor-pointer"
          />
          <Image
            src={fb}
            alt=""
            className="w-[16.84px] transition-all duration-500 ease-in-out hover:scale-125 hover:drop-shadow-[0_0_10px_rgba(71,49,113,1)]   hover:cursor-pointer"
          />
        </div>
